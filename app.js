...
var userName = prompt('While you are here, What is your name Intruder?');
...
function function3() {
  ...
  if (answer3 === 'y' || answer3 === 'yes'){
    ...
    alert('You are wrong. 2 Thumbs Down for you ' + userName + '.');
...
function function4() {
  ...
  if (answer4 === 'y' || answer4 === 'yes'){
    ...
    alert('Oh, I was just starting to like you ' + userName + '.');
...
function function5() {
  ...
  if (answer5 === 'y' || answer5 === 'yes'){
    ...
    console.log(userName + ', Can we be Friends? You said yes.');
    yourPoints++;
  } else {
...
function function6() {
  ...
  while (numberGuesses <= 5){
    ...
    if (answer6 > 125){
      ...
      alert('Try again, you are too low. Talking about Football here.');
      numberGuesses++;
    }
    if (answer6 === 125){
    ...
    if (numberGuesses === 4){
      alert('You are out of guesses ' + userName + ', better luck next time.');
      break;
    }
  }
...
function function7() {
  ...
  if (sixTries === 7) {
    alert('You are out of tries. The correct answers are ' + bucketList[i] + '.');
  }
